# 2class_Swin_train_multimodal_oof.py
#
...
#
# 執行：
#   python Swin_train_multimodal_oof.py --model_name swin_tiny
...
FOCAL_LOSS_ALPHA = {
    ...
    "OCT1":       [0.113, 0.887],
    "OCTA3":      [0.130, 0.870],
    "MULTIMODAL": [0.120, 0.880],   # ← 依合併後 class 比例設定
}
...
MANUAL_SAMPLE_WEIGHTS = {
    ...
    "OCT1":       [1.0, 2.8],
    "OCTA3":      [1.0, 2.6],
    "MULTIMODAL": [1.0, 2.7],   # ← 依合併後 class 比例設定
}
...
def train_one_fold(
    ...
    # ★ 改動④：resize 高度改為 448（寬保持 224），augmentation ratio 配合調整
