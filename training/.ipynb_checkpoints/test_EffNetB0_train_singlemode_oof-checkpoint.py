# test_EffNetB0_train_singlemode_oof.py
...
EFFNET_FROZEN_BLOCK_INDICES    = [0, 1, 2, 3, 4, 5]   # 凍結
EFFNET_TRAINABLE_BLOCK_INDICES = [6]                  # 解凍（對應 VGG16 Block5）
