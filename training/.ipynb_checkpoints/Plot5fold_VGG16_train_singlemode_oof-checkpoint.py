# Plot5fold_VGG16_train_singlemode_oof.py
"""
...
Usage:
  python Plot5fold_VGG16_train_singlemode_oof.py --modality OCT0
  python Plot5fold_VGG16_train_singlemode_oof.py --modality OCT1
  python Plot5fold_VGG16_train_singlemode_oof.py --modality OCTA3
"""
...
TRAINING_OUTPUT_ROOT = os.path.join(VGG16_BASE_DIR  , "training_plot")
