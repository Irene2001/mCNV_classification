...
Input
-----
VGG16_outputs/oof_predictions/<model>/<strategy>/<modality>/<RUN_TAG>/all_folds_oof_calibrated.csv
...
Output
------
VGG16_outputs/meta_dataset/<meta_tag>/<strategy>/<lr_folder>/
...
META_ROOT    = os.path.join(EFFNET_BASE_DIR, "meta_dataset")


# ── Experiment config ─────────────────────────────────────────────────────────
MODEL_NAME = "efficientnet_b0"
STRATEGY_NAME = "Partial_B5_6"  # Add: Unfreezing layer folder
...
def load_oof(modality: str, feature_col: str):
    ...
    base    = os.path.join(OOF_ROOT, MODEL_NAME, STRATEGY_NAME, modality, run_tag)
