...
META_MODEL_PATH = (
    "/data/Irene/SwinTransformer/Swin_Meta/outputs/meta_training/"
    "swin_tiny__logit__calibTrue/"
    "OCT0_LR2e-06_OCT1_LR4e-06_OCTA3_LR3e-06/"
    "meta_lr_model.pkl"
)
...
def load_test_preds(modality: str, feature_col: str, logf) -> pd.DataFrame:
    ...
    """
    path = os.path.join(
        TEST_EVAL_ROOT, MODEL_NAME, modality,
...
def main() -> None:
    ...
    print(f"\n{'='*62}")
    print("STACKING META-LEARNER TEST EVALUATION")
    print(f"{'='*62}")
