# AddPatientsCount_build_meta_dataset.py
# Revise: patients counts in line 282~284
...
def main() -> None:
    ...
    info = {
        ...
        "samples": {
            ...
            # ---Revise: patients counts---
            "meta_train_exams": n_meta,  # Original: meta_train
            "meta_train_patients": int(df_meta["patient_id"].nunique()), # Add: patients counts!
