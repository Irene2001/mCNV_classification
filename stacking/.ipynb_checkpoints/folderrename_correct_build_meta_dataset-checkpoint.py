# folderrename_correct_build_meta_dataset.py
"""
...
Example full path:
  .../meta_dataset/swin_tiny__logit__calibTrue/
      OCT0_LR2e-06_OCT1_LR3e-06_OCTA3_LR4e-06/
          meta_train_oof.csv

Usage
-----
python build_meta_dataset.py          # uses CONFIG block below
"""
