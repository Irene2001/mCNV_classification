...
# OCT0: BS16_EP100_LR1e-05_WD0.01_DR0.5_FIXED_BACKBONE_FL0.11_0.89_2_WSon_1_2.9/
# OCT1: BS16_EP100_LR1e-05_WD0.01_DR0.5_FIXED_BACKBONE_FL0.113_0.887_2_WSon_1_2.8/
# OCTA3: BS16_EP100_LR2e-05_WD0.01_DR0.5_FIXED_BACKBONE_FL0.13_0.87_2_WSon_1_2.6/
...
ECE_N_BINS   = 10    # equal-width bins for ECE 
BATCH_SIZE   = 16
NUM_WORKERS  = 4
IMG_SIZE     = 224
RANDOM_SEED  = 42
...
def main() -> None:
    ...
    out_dir = os.path.join(test_eval_root, model_name, strategy, modality, run_tag, f"Best_fold{best_fold}")
    ensure_dir(out_dir)
